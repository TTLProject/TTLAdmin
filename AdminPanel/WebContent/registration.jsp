...
title="enter aplhabets only max 30 characters" required="">
			</div>
			<div class="w3l-user">
			...
			<div class="w3l-options1">
				<label class="head">Designation<span class="w3l-star"> * </span></label>	
					<select class="category1" required="" name="designation">
						...
						<option value="excutivequalityanalyst">Excutive Quality Analyst</option>
						<option value="excutivesoftwaredeveloper">Excutive Software Developer</option>
					</select>
			</div><br>
			<br><br><br>
