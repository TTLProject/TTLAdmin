...
public class Email1 {
	...
	public static void mail(Userbean user) throws ClassNotFoundException {
		...
		final String toEmail = user.getEmailid(); // can be any email id 
		...
		String body= "<table border=1 align=center><tr><th>username</th><th>password</th></tr><tr><td>"+user.getUsername()+"</td><td>"+user.getPassword()+"</td></tr></table>"; 
